 ...
 */
public class WeatherInteractor implements NoteInputBoundary {  // Note: InputBoundary is not done yet
    ...
    public void weatherInteractor(WeatherDataAccessInterface weatherDataAccessInterface,
        ...
        this.weather = weatherDataAccessInterface.getWeather(noteOutputBoundary.getCityName()); // Note: getCityName is not done yet
    }
